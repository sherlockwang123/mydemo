...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">音乐日志分析可视化系统</a>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-charts">
            ...
            <dd>
                <ul>
                    <li><a data-href="/charts/log1" data-title="用户歌曲点击量分布图" >用户歌曲点击量分布图</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/log2" data-title="歌手被点击量分布图" >歌手被点击量分布图</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/log3" data-title="用户收藏量分布图" >用户收藏量分布图</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/log4" data-title="歌手比例分布图" >歌手比例分布图</a></li>
                </ul>
