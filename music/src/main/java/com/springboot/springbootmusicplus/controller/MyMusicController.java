...
import com.springboot.springbootmusicplus.entity.musicLog;
...
import com.springboot.springbootmusicplus.utils.TimeUtil;
...
public class MyMusicController {
    ...
    @ResponseBody
    public void getAddHdfs(@RequestParam Integer userId,@RequestParam Integer songId) {
       User user= userService.getUserInfoByUserId(userId);
       Musiclink  my =musiclinkService.getMusiclinkInfoById(songId);
       musicLog musciLog=new musicLog(user.getUserId(),user.getUserName(),my.getMlSongname(),my.getMlSinger(), TimeUtil.getTimes());
        String line= JSONObject.toJSONString(musciLog);
        hdfsService.dataToHDFS(line);
    }
